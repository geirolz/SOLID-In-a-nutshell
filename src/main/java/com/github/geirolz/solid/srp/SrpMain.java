...
public class SrpMain {
    ...
    private static final Order order1 = new Order("order1", "Andrea", "Via ... 1", "Rossi", "IT", new BigDecimal(100), OrderStatus.CREATED, shippingService);
    private static final Order order2 = new Order("order2", "Luca", "Via ... 5", "Bianchi", "UK", new BigDecimal(130), OrderStatus.CANCELLED, shippingService);
